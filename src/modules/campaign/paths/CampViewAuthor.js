...
import CamImage from "./CampImage";
    ...
    <div className="flex justify-start gap-x-[20px]">
      ...
      <div className="flex flex-col justify-center gap-y-[5px]">
        <div className="flex  gap-x-[15px]">
          <h4 className="text-text1 font-medium text-[18px]">Saiful Islam</h4>
        ...
        <div className="flex items-center gap-x-[10px]">
          <p className="text-primary font-semibold text-[14px]">02 Campaign</p>
          <span className="block w-[6px] h-[6px] rounded-full bg-text3"></span>
          <p className="text-text3 font-light text-[14px]">Dhaka, Bangladesh</p>
        </div>
      </div>
    </div>
  );
